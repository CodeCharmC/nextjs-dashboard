...
export default async function Page() {
   ...
   const latestInvoices = await fetchLatestInvoices(); //fetchLatestInvoices() will only start fetching data when fetchRevenue() is done

   const { totalPaidInvoices, totalPendingInvoices, numberOfInvoices, numberOfCustomers } = await fetchCardData(); //fetchCardData() will only start fetching data when fetchLatestInvoices() is done
